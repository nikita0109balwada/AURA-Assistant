...
class ChatBubble(ctk.CTkFrame):
    def __init__(self, master, text, is_user=False):
        ...
        self.label.grid(row=0, column=0, sticky="w")  # Removed padx, pady, sticky
...
def change_location():
    global current_city
    # Simple popup to enter a new city
    new_city = ctk.simpledialog.askstring("Change City", "Enter City Name:")
    if new_city:
